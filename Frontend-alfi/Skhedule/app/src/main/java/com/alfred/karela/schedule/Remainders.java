...
public class Remainders extends AppCompatActivity implements
...
/*        CheckBox ahl = (CheckBox) findViewById(R.id.autohighlight_checkbox);
        ...
        createprivate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Remainders.this, "event name: "+ename+"event location: "+eloc+"event description: " + edesc , Toast.LENGTH_LONG).show();
            }
        });
    }
