...
public class CompactCalendarTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final FloatingActionButton slideCalendarBut = (FloatingActionButton) v.findViewById(R.id.slide_calendar);
        ...
        final TextView text1  = (TextView) v.findViewById(R.id.textView);
        ...
        text1.setText(dateFormatForMonth.format(compactCalendarView.getFirstDayOfCurrentMonth()));

        //set title on calendar scroll
        compactCalendarView.setListener(new CompactCalendarView.CompactCalendarViewListener() {
            @Override
            public void onDayClick(Date dateClicked) {
                text1.setText(dateFormatForMonth.format(dateClicked));
            ...
            public void onMonthScroll(Date firstDayOfNewMonth) {
                text1.setText(dateFormatForMonth.format(firstDayOfNewMonth));
            }
        });
/*
...
*/
    ...
    public void onResume() {
        ...
        //text1.setText(dateFormatForMonth.format(new Date()));
    }
    ...
    private List<Event> getEvents(long timeInMillis, int day) {
        if (day < 2) {
            ...
            return Arrays.asList(
                    new Event(Color.argb(255, 169, 68, 65), timeInMillis, "Private Event(INternet of Things ) at " + new Date(timeInMillis)),
